...
if (!empty($searchValue)) {
  $list = $trajetC->searchTrajetsbyUser($id,$searchValue);
} else if ($sort === 'date' || $sort === 'price') {
  $list = $trajetC->getAllSortedByUser($id,$sort);
} else {
  $list=$trajetC->findByuser($id);
    }
  ...
  <section class="client_section layout_padding">
    ...
    <form id="searchForm" method="POST" action="">
      ...
      <h2>List des trajets</h2>
        ...
        <a href="addTrajet.php" class="action-btn"> ajout Trajet </a>
        <table class="styled-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="deleteTrajet.php?id=<?php echo $trajet['id']; ?>" style="padding: 8px 12px;background-color: red;color: #fff;border: none;border-radius: 5px;cursor: pointer;transition: background-color 0.3s;">delete</a>
                    <a href="ReservationConducteur.php?id=<?php echo $trajet['id']; ?>" class="action-btn">about</a>
                    <a href="updateTrajet.php?id=<?php echo $trajet['id']; ?>" style="padding: 8px 12px;background-color: green;color: #fff;border: none;border-radius: 5px;cursor: pointer;transition: background-color 0.3s;">update</a>
                  </td>
                </tr>
                <?php }} ?>
            </tbody>
